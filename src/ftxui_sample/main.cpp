...
// configuration step. It creates a namespace called `cmake_demo`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_demo::cmake::project_name, cmake_demo::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_demo::cmake::project_version);
      return EXIT_SUCCESS;
    }
